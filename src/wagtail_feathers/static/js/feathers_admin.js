...
Controller.outlets = [];
Controller.values = {};
class ClassifierModalController extends Controller {
  connect() {
  ...
  updateManagementForm() {
    ...
    this.element.querySelector(`input[name="${prefix}-INITIAL_FORMS"]`);
    if (totalFormsInput) {
  ...
  toggleAllGroups(event) {
    ...
    button.querySelector(".collapse-all-icon");
  ...
  handleSearch(event) {
    ...
    items.forEach((item) => {
      var _a, _b, _c;
      const name = ((_a = item.dataset.classifierName) == null ? void 0 : _a.toLowerCase()) || "";
      const group = ((_b = item.dataset.group) == null ? void 0 : _b.toLowerCase()) || "";
      const type = ((_c = item.dataset.type) == null ? void 0 : _c.toLowerCase()) || "";
      const matches = name.includes(searchTerm) || group.includes(searchTerm) || type.includes(searchTerm);
  ...
  updateGroupSelectionCounts() {
    ...
    groups.forEach((group) => {
      ...
      group.querySelectorAll(".classifier-item input").length;
  ...
  debugFormsetState(context = "") {
    ...
    console.log(`  TOTAL_FORMS: ${(totalFormsInput == null ? void 0 : totalFormsInput.value) || "not found"}`);
    console.log(`  INITIAL_FORMS: ${(initialFormsInput == null ? void 0 : initialFormsInput.value) || "not found"}`);
...
Forms found: ${forms.length}`);
    forms.forEach((form, index) => {
      ...
      console.log(`  id field value: ${(idField == null ? void 0 : idField.value) || "empty"}`);
      console.log(`  DELETE field value: ${(deleteField == null ? void 0 : deleteField.value) || "empty"}`);
      console.log(`  classifier select value: ${(selectField == null ? void 0 : selectField.value) || "none"}`);
...
__publicField(ClassifierModalController, "targets", ["searchInput", "classifierList", "classifierItem", "selectedCount"]);
