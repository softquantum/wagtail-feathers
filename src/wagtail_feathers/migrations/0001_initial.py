# Generated by Django 5.2.5 on 2025-08-24 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='media.customimage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('og_image', models.ForeignKey(blank=True, help_text='Image for social media sharing (Open Graph/Twitter). Recommended: 1200x630px', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='media.customimage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.ForeignKey(help_text='Document download', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='media.customdocument')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placeholder_image', models.ForeignKey(blank=True, help_text='Choose the image you wish to be displayed as a placeholder image.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='media.customimage')),
